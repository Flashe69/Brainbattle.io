...
!function(e){function n(){a.slimScroll({color:"#8589a7",size:"6px",height:"100%",opacity:"1",alwaysVisible:!0,railVisible:!0,railColor:"#eaeaea",railOpacity:.3,wheelStep:10,allowPageScroll:!1,disableFadeOut:!1})}function t(){l.slimScroll({color:"#8589a7",size:"6px",height:"100%",opacity:"1",alwaysVisible:!0,railVisible:!0,railColor:"#eaeaea",railOpacity:.3,wheelStep:10,allowPageScroll:!1,disableFadeOut:!1})}WebFont.load({google:{families:["Open Sans","Roboto","Ubuntu"]}}),e(document).ready(function(){var e,n,t=Date.now(),a=2e4,l=document.getElementById("timer_sec"),i=document.getElementById("timer_mili"),o=Date.now(),r=0,c=document.getElementById("timer2"),s=setInterval(function(){e=Date.now(),new Date(a-e+t).getSeconds()<10?l.innerHTML="0"+new Date(a-e+t).getSeconds()+".":l.innerHTML=new Date(a-e+t).getSeconds()+".",i.innerHTML=new Date(a-e+t).getMilliseconds(),e-t>=a&&(clearInterval(s),l.innerHTML="00.",i.innerHTML="000"),n=Date.now(),new Date(r+n-o).getSeconds()<10?c.innerHTML="0"+new Date(r+n-o).getSeconds()+"."+new Date(r+n-o).getMilliseconds():c.innerHTML=new Date(r+n-o).getSeconds()+"."+new Date(r+n-o).getMilliseconds(),r+n-o>=2e4&&(clearInterval(s),c.innerHTML="20.000")},21)});var a=e(".modal-scrollProject"),l=e(".modal-scrollWinners"),i=e(".modal-cabinet").remodal(),o=e(".modal-project").remodal(),r=e(".modal-winners").remodal();e(".header__cabinet__btn").on("click",function(e){e.preventDefault(),i.open()}),e(".header__project__btn").on("click",function(e){e.preventDefault(),o.open(),n()}),e(".header__winners__btn").on("click",function(e){e.preventDefault(),r.open(),t()}),e(".questions__answer__items").on("click",function(){e(this).addClass("active"),e(this).siblings().removeClass("active")})}(jQuery);