...
!function(e){function n(){t.slimScroll({color:"#8589a7",size:"6px",height:"100%",opacity:"1",alwaysVisible:!0,railVisible:!0,railColor:"#eaeaea",railOpacity:.3,wheelStep:10,allowPageScroll:!1,disableFadeOut:!1})}function l(){i.slimScroll({color:"#8589a7",size:"6px",height:"100%",opacity:"1",alwaysVisible:!0,railVisible:!0,railColor:"#eaeaea",railOpacity:.3,wheelStep:10,allowPageScroll:!1,disableFadeOut:!1})}WebFont.load({google:{families:["Open Sans","Roboto","Ubuntu"]}}),e(document).ready(function(){var e=20,n=0,l=0,t=0,i=setInterval(function(){return e<=0?(clearInterval(i),document.getElementById("timer_sec").innerHTML="00.",void(document.getElementById("timer_mili").innerHTML="000")):((n-=10)<=0&&(e-=1,n=1e3),document.getElementById("timer_sec").innerHTML=e<10?"0"+e+".":e+".",document.getElementById("timer_mili").innerHTML=n,l>=20?(clearInterval(countUp),void(document.getElementById("timer2").innerHTML="20.000")):((t+=10)>=1e3&&(l+=1,t=0),void(document.getElementById("timer2").innerHTML=l<10?"0"+l+"."+t:l+"."+t)))},10)});var t=e(".modal-scrollProject"),i=e(".modal-scrollWinners"),o=e(".modal-cabinet").remodal(),a=e(".modal-project").remodal(),r=e(".modal-winners").remodal();e(".header__cabinet__btn").on("click",function(e){e.preventDefault(),o.open()}),e(".header__project__btn").on("click",function(e){e.preventDefault(),a.open(),n()}),e(".header__winners__btn").on("click",function(e){e.preventDefault(),r.open(),l()})}(jQuery);